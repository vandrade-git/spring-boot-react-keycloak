...
(global = global || self, factory(global['react-keycloak-web'] = {}, global.React));
...
function createReactKeycloakContext(initialContext) {
  return React.createContext(objectSpread2({
    initialized: false
  }, initialContext));
}
...
function createReactKeycloakProvider(ReactKeycloakContext) {
  var KeycloakProvider = /*#__PURE__*/function (_React$PureComponent) {
    inheritsLoose(KeycloakProvider, _React$PureComponent);
    ...
    function KeycloakProvider() {
      ...
      defineProperty(assertThisInitialized(_this), "defaultInitConfig", {
        onLoad: 'check-sso',
        promiseType: 'native'
      });

      defineProperty(assertThisInitialized(_this), "state", objectSpread2({}, initialState));

      defineProperty(assertThisInitialized(_this), "onKeycloakError", function (event) {
      ...
      defineProperty(assertThisInitialized(_this), "updateState", function (event) {
        return function () {
      ...
      defineProperty(assertThisInitialized(_this), "refreshKeycloakToken", function (event) {
        return function () {
    ...
    _proto.componentDidUpdate = function componentDidUpdate(_ref) {
      ...
      if (this.props.keycloak !== prevKeycloak || !reactFastCompare(this.props.initConfig, prevInitConfig)) {
        ...
        this.setState(objectSpread2({}, initialState)); // Init new Keycloak instance
    ...
    _proto.init = function init() {
      ...
      keycloak.init(objectSpread2(objectSpread2({}, this.defaultInitConfig), initConfig)).catch(this.onKeycloakError('onInitError'));
    };
...
function withKeycloak(WrappedComponent) {
  ...
  var WithKeycloakComponent = /*#__PURE__*/function (_React$PureComponent) {
    inheritsLoose(WithKeycloakComponent, _React$PureComponent);
    ...
    function WithKeycloakComponent() {
      ...
      defineProperty(assertThisInitialized(_this), "renderWrappedComponent", function (_ref) {
        var initialized = _ref.initialized,
            keycloak = _ref.keycloak;
        return /*#__PURE__*/React.createElement(WrappedComponent, _extends_1({}, _this.props, {
          keycloak: keycloak,
  ...
  return hoistNonReactStatics_cjs(WithKeycloakComponent, WrappedComponent);
}
