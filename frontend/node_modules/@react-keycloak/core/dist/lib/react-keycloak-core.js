...
function createReactKeycloakContext(initialContext) {
  return React.createContext(_objectSpread({
    initialized: false
  }, initialContext));
}
...
exports.createReactKeycloakContext = createReactKeycloakContext;
exports.createReactKeycloakProvider = createReactKeycloakProvider;
